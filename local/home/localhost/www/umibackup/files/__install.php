...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="http://install.umi-cms.ru/style_2.css?12" type="text/css" rel="stylesheet" />
		...
		<script src="http://install.umi-cms.ru/js/script_2.js?12" type="text/javascript"></script>
			...
			<div class="main">
				...
				<div class="display_none fourth_block shadow_some select_demosite_type">
					<div class="demo_templates" >
						<label>
							<input type="radio" name="type_of_site" value="demo"/>Выбор демо-сайта
							<img src="http://install.umi-cms.ru/demo.png" />
						</label>
						...
						<!--div class="description">Демонстрационные сайты, на которых можно попробовать все возможности UMI.CMS: протестировать модули, функции и настройки, заполнить структуру и контент, поработать с каталогами, фотогалереями и заказами. Демо-сайты развиваются вместе с продуктом, дополняются новым функционалом и возможностями, а веб-разработчиками могут использоваться как образец для разработки.</div-->
					</div>
					<div class="umiru_templates">
						<label>
							<input type="radio" name="type_of_site" value="umiru"/>Выбор готового сайта
							<img src="http://install.umi-cms.ru//umiru.png" />
						</label>
						<div class="description">
							<p>500 готовых сайтов для различных отраслей бизнеса с готовым дизайном, структурой и контентом.</p>
							<p>Установка поддерживается на редакциях Corporate, Business, Commerce. Посмотреть готовые сайты можно в <a href="http://demo.umi-cms.ru/" target="_blank">демо-центре</a>.</p>
						</div>
						<div class="description display_none">
							<p>500 готовых сайтов для различных отраслей бизнеса с  готовым дизайном, структурой и контентом.</p>
							<p>Установка поддерживается на редакциях Corporate, Business, Commerce. В вашей редакции редакции установка готового сайта не поддерживается. Посмотреть готовые сайты можно в <a href="http://demo.umi-cms.ru/" target="_blank">демо-центре</a>.</p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="display_none fourth_block shadow_some select_umi_demosite">
					<div class="choose_umisite">
						...
						<div class="umiru_body">
							<div class="doc">
								<input class="search" value="Введите номер сайта" type="text" />
			...
			<div class="footer">
				<div class="load_bottom">
					...
					<ul>
						...
						<li><div>Выбор<br />сайта</div></li>
						<li><div>Установка<br />сайта</div></li>
