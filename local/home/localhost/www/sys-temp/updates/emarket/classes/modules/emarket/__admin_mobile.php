<?php
	...
	abstract class __emarket_admin_mobile extends baseModuleAdmin {
		...
		public function getOrdersByStatus() {
			...
			foreach($result as $order) {
				...
				$orderInfo = array (
					...
					'@orderDate' => $this->toDateFormat($order->getValue('order_date')->getDateTimeStamp()),
		...
		public function getOrder() {
			...
			$orderData = array(
				...
				'orderDate' => array(
					...
					'@value' => (string) $this->toDateFormat($order->getValue('order_date')->getDateTimeStamp())
				),
				'orderPrice' => array(
		...
		public function setOrder() {
			...
			$status = 'not changed';
			foreach ($statusMapping as $requestKey => $objectKey) {
