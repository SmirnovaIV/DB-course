...
<body>
	<div class="exception">
		...
		<div id="message">
			<h2>Ошибка <?php echo $v42552b1f133f9f8eb406d4f306ea9fd1->type ? "(" . $v42552b1f133f9f8eb406d4f306ea9fd1->type . ")" : "" ?>: <?php echo $v42552b1f133f9f8eb406d4f306ea9fd1->message;?></h2>
			...
			<?php if (DEBUG_SHOW_BACKTRACE) {?>
				...
				<div id="trace" class="trace" style="display: none;"><pre><?php echo $v42552b1f133f9f8eb406d4f306ea9fd1->traceAsString;?></pre></div>
			<?php }?>
		</div>
		<div id="footer">
