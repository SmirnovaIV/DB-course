						...
						<ul class="menu_pages_list">
							<li class="ti">
								<div class="ti">
									...
									<a class="systemLink" href="{$lang-prefix}/emarket/cart">
							...
							<li class="ti">
								<div class="ti">
									<img style="border: 0px none;" alt="&label-menu-page-content;" title="&label-menu-page-content;" src="/images/cms/admin/mac/tree/ico_content_.png" class="ti-icon" />
									<a class="systemLink" href="{$lang-prefix}/users/registrate">
							...
							<li class="ti">
								<div class="ti">
									...
									<a class="systemLink" href="{$lang-prefix}/users/login">
							...
							<li class="ti">
								<div class="ti">
									...
									<a class="systemLink" href="{$lang-prefix}/users/settings/">
							...
							<li class="ti">
								<div class="ti">
									...
									<a class="systemLink" href="{$lang-prefix}/users/forget/">
